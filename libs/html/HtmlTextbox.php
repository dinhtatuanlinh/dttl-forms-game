...
class HtmlTextbox{
	...
	public static function create($name = '', $value = '', $placeholder = '' ,  $attr = array(), $options = null){
		...
		//Tạo phần tử HTML
		$html = '<input type="text" name="'. $name . '" ' . $strAttr . ' value="' . $value . '" placeholder="' . $placeholder . '" />';
